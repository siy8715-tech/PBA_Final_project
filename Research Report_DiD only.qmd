...
Across all empirical approaches—descriptive comparisons, Difference-in-Differences estimates, event-study dynamics, and continuous first-difference regressions—the results consistently show **no evidence that short-run increases in tertiary-education spending led to higher enrollment rates in the immediate post-COVID period**.

Any association between spending increases and enrollment declines appears driven by **policy responses to worsening conditions**, rather than causal effects of spending on enrollment.
