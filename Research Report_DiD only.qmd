...
approach_tbl <- data.frame(
`Methodological Component` = c(
"Difference-in-Differences",
"Event Study",
"First Difference"
),
Purpose = c(
"Estimate average effect of large spending increases",
"Test parallel trends and visualize dynamic effects",
"Assess continuous relationship between spending and enrollment"
),
check.names = FALSE
)
