...
Importantly, this design does not assume that funding adjustments were mechanically caused by enrollment changes. Instead, it treats the 2020–2021 spending change as a heterogeneous funding-policy response across countries and estimates whether enrolment evolved differently in countries with larger versus smaller adjustments, conditional on fixed effects and pre-trend diagnostics.
ation of pre- and post-treatment evolution and allows for visualization of treatment timing.
